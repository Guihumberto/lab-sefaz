  ...
  state: () => ({
    ...
    chamados:[
      ...
      {id: 6, ordem:6, oldOrdem: 6, ordemCham: 1, nrocham: 0, textSolic: 'Documentação serviço DTE',  mod: '',
        textObs: '', consultor: 1, priority: 1, idProject: 2, prevdate: '', status: 2},
      ...
      {id: 9, ordem:9, oldOrdem: 9, ordemCham: 1, nrocham: 0, textSolic: 'Acesso ao banco de dados central de placas de veículo de carga',  mod: '',
        textObs: '', consultor: 1, priority: 1, idProject: 3, prevdate: '', status: 1},
      ...
      {id: 16, ordem:16, oldOrdem: 16, ordemCham: 1, nrocham: 0, textSolic: 'Publicação de biblioteca java no servidor de Sonatype NEXUS', mod: '',
        textObs: '', consultor: 1, priority: 1, idProject: 4, prevdate: '', status: 5},
      {id: 17, ordem:17, oldOrdem: 17, ordemCham: 1, nrocham: 64717, textSolic: 'Solicitação de serviço para identificação do "tipoContribuinte" e "codigoTipoDare" na emissão do DARE', mod: '',
        textObs: '', consultor: 0, priority: 1, idProject: 1, prevdate: '', status: 0},
    ],
  }),
  getters: {
    readStatus(){
